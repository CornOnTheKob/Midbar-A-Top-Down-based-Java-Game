...
public class Giant_Mob_F extends Creature {
    
    public Random r;

    public Giant_Mob_F(GameFrame gp, long seede){
        super(gp);
        direction = "down";
        speed = 4;
        type = 3;
...
// //7 and 29 
    ...
    public void getSpriteImage(){
        try{
            ...
            up1 = ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/u1.png"));
            up2 =  ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/u2.png"));
            down1 =  ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/d1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/d2.png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/l1.png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/l2.png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/r1.png"));
            right2 =  ImageIO.read(getClass().getResourceAsStream("Midbar/Objects/Mobs/GiantMob2/r2.png"));
